		...
		if ( $.isArray( this.options.source ) ) {
			...
			this.source = function( request, response ) {
                ...
                if (this.options.ignore){
                    ...
                    var _i, len, id_list;
                    id_list = 0;
                    for(_i = 0, len = ignore.length; _i < len; _i++){
                        id_list += ',' + ignore[_i];
                    }
                    request['ignore'] = id_list;
                }
				that.xhr = $.ajax({
					url: url,
					data: request,
...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		yearRange: "1970:"+year, // Range of years to display in drop-down,
...
var dialog = $.widget( "ui.dialog", {
	...
	_title: function( title ) {
		...
		title.html( '<span class="ui-dialog-title-title">' + this.options.title + '</span>' );
        if (this.options.subtitle){
            title.append( '<span class="ui-dialog-subtitle">' + this.options.subtitle + '</span>' );
        }
	},
